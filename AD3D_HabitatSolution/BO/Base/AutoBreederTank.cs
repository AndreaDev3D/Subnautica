...
namespace AD3D_HabitatSolutionMod.BO
{
    ...
    public class AutoBreederTank : Buildable
    {
        ...
        public override GameObject GetGameObject()
        {
            ...
            GameObject _prefab = GameObject.Instantiate(QPatch.Bundle.LoadAsset<GameObject>("AutoBreederTank.prefab"));
        ...
        private static void ApplySubnauticaShaders(GameObject gameObject)
        {
            ...
            var glassRenderer = new Renderer[] { glass };
            SkyApplier skyApplier = gameObject.EnsureComponent<SkyApplier>();
            skyApplier.renderers = Renderers.Except(glassRenderer).ToArray();
            skyApplier.anchorSky = Skies.Auto;


            SkyApplier skyApplier1 = gameObject.EnsureComponent<SkyApplier>();
            skyApplier1.renderers = glassRenderer;
            skyApplier1.anchorSky = Skies.BaseGlass;
        }
        protected override Atlas.Sprite GetItemSprite()
        {
            return AD3D_Common.Helper.GetSpriteFromBundle(QPatch.Bundle, $"{_ClassID}.png");
        }
    }
