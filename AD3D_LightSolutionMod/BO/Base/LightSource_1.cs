...
{
    public class LightSource_1 : Buildable
    {
        ...
        public LightSource_1() : base(_ClassID, _FriendlyName, _Description)
        {
        }
        ...
        public override GameObject GetGameObject()
        {
            ...
            GameObject _prefab = GameObject.Instantiate(Utils.Helper.Bundle.LoadAsset<GameObject>("LightSource_1.prefab"));
