...
namespace AD3D_EnergySolution.SN.BO.Runtime
{
    ...
    public class DeepEngineController : HandTarget, IHandTarget
    {
        ...
        public PowerSystemPreview _powerSystemPreview;
        ...
        private void SetupSolarPowerRelay()
        {
            this.gameObject.SetActive(false);

            _powerFX = this.gameObject.AddComponent<PowerFX>();
            _powerSystemPreview = this.gameObject.AddComponent<PowerSystemPreview>();
            ...
            _powerFX.attachPoint = this.transform;

            _powerSystemPreview.powerRelay = this._powerRelay;
            _powerSystemPreview.previewPowerFX = _powerFX;

            _powerRelay.powerSystemPreviewPrefab = Instantiate(new GameObject("PowerSystemPreview"));
            _powerRelay.dontConnectToRelays = false;
            _powerRelay.powerFX = _powerFX;
            _powerRelay.internalPowerSource = _powerSource;
            _powerRelay.lastCanConnect = true;
            _powerRelay.outboundRelay = this._powerRelay;
            _powerRelay.maxOutboundDistance = 15;

            this.gameObject.SetActive(true);
        }

        private IEnumerator SetupSolarPowerRelayAsync()
        {
